...
@section('content')
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="panel panel-body login-form">
            ...
            <div class="form-group has-feedback has-feedback-left {{ $errors->has('contact') ? ' has-error' : '' }}">
                <input type="text" class="form-control" placeholder="Your contact" name="contact" value="{{ old('contact') }}" required>
                <div class="form-control-feedback">
