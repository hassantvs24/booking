...
@section('content')
    ...
    <section id="award-section" class="award-section sec-ptb-100 clearfix">
        <div class="container">
            <div class="row">
                ...
                <!-- company-age - start -->
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="company-age sr-fade1" style="background-image: url({{asset('public/frontend/assets/images/about/company-age-bg.jpg')}});">
                        <div class="banner-img">
                            <img src="{{asset('public/frontend/assets/images/about/company-banner.png')}}" alt="Image_not_found">
                        </div>
                    </div>
                </div>
                <!-- company-age - end -->
    ...
    <div id="absolute-sponsor-section" class="absolute-sponsor-section sr-fade1 clearfix">
        <ul>
            ...
            <li>
                <a href="#!">
                    <img src="{{asset('public/frontend/assets/images/partners/image1.png')}}" alt="Image_not_found">
                </a>
            </li>
            <li>
                <a href="#!">
                    <img src="{{asset('public/frontend/assets/images/partners/image2.png')}}" alt="Image_not_found">
                </a>
            </li>
            <li>
                <a href="#!">
                    <img src="{{asset('public/frontend/assets/images/partners/image4.png')}}" alt="Image_not_found">
                </a>
            </li>
            <li>
                <a href="#!">
                    <img src="{{asset('public/frontend/assets/images/partners/image6.png')}}" alt="Image_not_found">
                </a>
            </li>
    ...
    ================================================== -->
    <section id="speaker-section" class="speaker-section clearfix" style="background-image: url({{asset('public/frontend/assets/images/speaker/Black-White-Dubai-Wallpaper.jpg')}});">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="speaker-image image-wrapper text-center">
                                        <img src="{{asset('public/frontend/assets/images/speaker/speakes1.png')}}" alt="Image_not_found">
                        ...
                        <div class="item">
                            <div class="item-content">
									<span class="speaker-thumbnail">
										<img src="{{asset('public/frontend/assets/images/speaker/speakes-thumbnail.png')}}" alt="Image_not_found">
									</span>
