                    ...
                    <div class="instagram-wrapper ul-li">
                        ...
                        <ul>
                            <li class="image-wrapper">
                                <img src="{{asset('public/frontend/assets/images/footer/instagram/img1.png')}}" alt="Image_not_found">
                                <a href="#!"><i class="fab fa-instagram"></i></a>
                            </li>
                            <li class="image-wrapper">
                                <img src="{{asset('public/frontend/assets/images/footer/instagram/img2.png')}}" alt="Image_not_found">
                                <a href="#!"><i class="fab fa-instagram"></i></a>
                            </li>
                            <li class="image-wrapper">
                                <img src="{{asset('public/frontend/assets/images/footer/instagram/img3.png')}}" alt="Image_not_found">
                                <a href="#!"><i class="fab fa-instagram"></i></a>
                            </li>
                            <li class="image-wrapper">
                                <img src="{{asset('public/frontend/assets/images/footer/instagram/img4.png')}}" alt="Image_not_found">
                                <a href="#!"><i class="fab fa-instagram"></i></a>
                            </li>
                        </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="text-center">
                        <p class="m-0">&copy; 2020  Harmoni all right reserved</p>
                    </div>
                </div>
                <!-- copyright-text - end -->
