...
@extends('settings.box.rules')
@section('title')
    @lang('site.content.rules_title')
@endsection
@section('content')
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-12">
            <div class="panel panel-flat border-top-success">
                <div class="panel-heading">
                    <h6 class="panel-title">@lang('site.content.rules_page')</h6>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.ediBtn').click(function () {
                ...
                var rulesFor = $(this).data('rulesfor');

                $('#ediModal form').attr('action', url);
                $('#ediModal [name=name]').val(name);
                $('#ediModal [name=rulesFor]').val(rulesFor);
